...
import org.oscim.tiling.source.mvt.ESRITileSource;
...
public class ESRITest extends GdxMapApp {
    ...
    public void createLayers() {
        ...
        UrlTileSource tileSource = ESRITileSource.builder()
                .httpFactory(factory)
                //.locale("en")
                .build();
